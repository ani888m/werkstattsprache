...
const content = {
  ...
  B_W: [
    ["<img src='./images/1.jpg' />", "match1"],
    ["-r Effelierer", "match1"],
    ["<img src='./images/2.jpg' />", "match2"],
    ["-r Kamm", "match2"],
    ["<img src='./images/3.jpg' />", "match3"],
    ["-e Haarschneide- <br> maschine", "match3"],
    ["<img src='./images/4.jpg' />", "match4"],
    ["-e Trockenhaube", "match4"],
    ["<img src='./images/5.jpg' />", "match5"],
    ["-r Föhn", "match5"],
    ["<img src='./images/6.jpg' />","match6"],
    ["-r Lockenstab", "match6"],
    ["<img src='./images/7.jpg' />", "match7"],
    ["-s Climazon", "match7"],
    ["<img src='./images/8.jpg' />", "match8"],
